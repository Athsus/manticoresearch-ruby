...
module Manticoresearch
  ...
  class IndexApi
    ...
    def bulk(body)
      bulk_with_http_info(body)
    end

    # Performs a bulk operation with HTTP info.
    # @param body [Hash] The bulk request body.
    # @return [Hash] The response from the API.
    def bulk_with_http_info(body)
      ...
      header_content_type = @api_client.select_header_content_type(['application/x-ndjson']) || 'application/x-ndjson'
      header_params['Content-Type'] = header_content_type

      # Convert body to x-ndjson
      ndjson_body = body.map { |item| "#{item.to_json}\n" }.join
      # Call the API
      @api_client.call_api(
        '/bulk',
        'POST',
    ...
    # @return [Hash] The response from the API.
    def delete(delete_document_request)
      delete_with_http_info(delete_document_request)
    end

    # Deletes a document with HTTP info.
    # @param delete_document_request [Hash] The delete request parameters.
    # @return [Hash] The response from the API.
    def delete_with_http_info(delete_document_request)
    ...
    # @return [Hash] The response from the API.
    def insert(insert_document_request)
      insert_with_http_info(insert_document_request)
    end

    # Inserts a document with HTTP info.
    # @param insert_document_request [Hash] The insert request parameters.
    # @return [Hash] The response from the API.
    def insert_with_http_info(insert_document_request)
      # Ensure the required parameter is provided
    ...
    # @return [Hash] The response from the API.
    def replace(insert_document_request)
      replace_with_http_info(insert_document_request)
    end

    # Replaces a document with HTTP info.
    # @param insert_document_request [Hash] The replace request parameters.
    # @return [Hash] The response from the API.
    def replace_with_http_info(insert_document_request)
      # Ensure the required parameter is provided
      unless insert_document_request
    ...
    # @return [Hash] The response from the API.
    def update(update_document_request)
      update_with_http_info(update_document_request)
    end

    # Updates a document with HTTP info.
    # @param update_document_request [Hash] The update request parameters.
    # @return [Hash] The response from the API.
    def update_with_http_info(update_document_request)
      # Ensure the required parameter is provided
    ...
    # @return [Hash] The response from the API.
    def update_partial(index, id, replace_document_request)
      update_partial_with_http_info(index, id, replace_document_request)
    end
    ...
    # @param replace_document_request [Hash] The partial update request parameters.
    # @return [Hash] The response from the API.
    def update_partial_with_http_info(index, id, replace_document_request)
